...
with AWS.Client;
with AWS.Messages;
package body ASF.Clients.Web is
   ...
   begin
      Http.Request := new AWS_Http_Request;
   end Create;
   ...
   procedure Do_Get (Manager  : in AWS_Http_Manager;
      ...
      Req     : constant AWS_Http_Request_Access
        := AWS_Http_Request'Class (Http.Request.all)'Access;
   ...
   begin
      ...
      Reply.Status := To_Status (AWS.Response.Status_Code (Rep.Data));
   end Do_Get;
